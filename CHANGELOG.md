...
- Renamed `steampipe.spvars.example` files to `powerpipe.ppvars.example` and updated documentation. ([#38](https://github.com/turbot/steampipe-mod-azure-tags/pull/38))
