...
control "application_security_group_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_application_security_group")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "batch_account_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_batch_account")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_availability_set_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_availability_set")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_disk_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_disk")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_disk_encryption_set_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_disk_encryption_set")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_image_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_image")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_snapshot_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_snapshot")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "compute_virtual_machine_scale_set_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_compute_virtual_machine_scale_set")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "container_registry_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_container_registry")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cosmosdb_account_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_cosmosdb_account")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cosmosdb_mongo_database_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_cosmosdb_mongo_database")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "cosmosdb_sql_database_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_cosmosdb_sql_database")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "data_factory_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_data_factory")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "eventhub_namespace_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_eventhub_namespace")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "firewall_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_firewall")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "iothub_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_iothub")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "key_vault_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_key_vault")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "key_vault_deleted_vault_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_key_vault_deleted_vault")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "key_vault_key_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_key_vault_key")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "key_vault_managed_hardware_security_module_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_key_vault_managed_hardware_security_module")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "key_vault_secret_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_key_vault_secret")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "kubernetes_cluster_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_kubernetes_cluster")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "lb_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_lb")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "log_alert_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_log_alert")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "log_profile_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_log_profile")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "logic_app_workflow_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_logic_app_workflow")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "mariadb_server_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_mariadb_server")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "mssql_elasticpool_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_mssql_elasticpool")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "mssql_managed_instance_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_mssql_managed_instance")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "mysql_server_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_mysql_server")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "network_interface_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_network_interface")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "network_security_group_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_network_security_group")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "network_watcher_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_network_watcher")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "network_watcher_flow_log_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_network_watcher_flow_log")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "postgresql_server_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_postgresql_server")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "public_ip_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_public_ip")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "recovery_services_vault_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_recovery_services_vault")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "redis_cache_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_redis_cache")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "route_table_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_route_table")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "search_service_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_search_service")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "servicebus_namespace_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_servicebus_namespace")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sql_database_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_sql_database")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "sql_server_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_sql_server")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "virtual_network_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_virtual_network")
  param "tag_limit" {
    default = var.tag_limit
  }
}
...
control "virtual_network_gateway_tag_limit" {
  ...
  sql         = replace(local.limit_sql_resource_group, "__TABLE_NAME__", "azure_virtual_network_gateway")
  param "tag_limit" {
    default = var.tag_limit
  }
}
