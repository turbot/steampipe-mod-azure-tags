...
control "api_management_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_api_management")
...
control "app_service_environment_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_app_service_environment")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "app_service_function_app_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_app_service_function_app")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "app_service_plan_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_app_service_plan")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "app_service_web_app_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_app_service_web_app")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "application_security_group_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_application_security_group")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "batch_account_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_batch_account")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_availability_set_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_availability_set")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_disk_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_disk")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_disk_encryption_set_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_disk_encryption_set")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_image_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_image")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_snapshot_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_snapshot")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_virtual_machine_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_virtual_machine")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "compute_virtual_machine_scale_set_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_compute_virtual_machine_scale_set")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "container_registry_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_container_registry")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "cosmosdb_account_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_cosmosdb_account")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "cosmosdb_mongo_database_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_cosmosdb_mongo_database")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "cosmosdb_sql_database_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_cosmosdb_sql_database")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "data_factory_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_data_factory")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "data_lake_analytics_account_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_data_lake_analytics_account")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "data_lake_store_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_data_lake_store")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "eventhub_namespace_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_eventhub_namespace")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "express_route_circuit_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_express_route_circuit")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "firewall_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_firewall")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "iothub_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_iothub")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "key_vault_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_key_vault")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "key_vault_deleted_vault_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_key_vault_deleted_vault")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "key_vault_key_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_key_vault_key")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "key_vault_managed_hardware_security_module_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_key_vault_managed_hardware_security_module")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "key_vault_secret_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_key_vault_secret")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "kubernetes_cluster_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_kubernetes_cluster")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "lb_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_lb")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "log_alert_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_log_alert")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "log_profile_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_log_profile")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "logic_app_workflow_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_logic_app_workflow")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "mariadb_server_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_mariadb_server")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "mssql_elasticpool_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_mssql_elasticpool")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "mssql_managed_instance_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_mssql_managed_instance")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "mysql_server_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_mysql_server")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "network_interface_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_network_interface")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "network_security_group_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_network_security_group")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "network_watcher_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_network_watcher")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "network_watcher_flow_log_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_network_watcher_flow_log")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "postgresql_server_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_postgresql_server")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "public_ip_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_public_ip")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "recovery_services_vault_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_recovery_services_vault")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "redis_cache_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_redis_cache")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "route_table_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_route_table")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "search_service_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_search_service")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "servicebus_namespace_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_servicebus_namespace")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "sql_database_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_sql_database")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "sql_server_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_sql_server")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "storage_account_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_storage_account")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "stream_analytics_job_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_stream_analytics_job")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "virtual_network_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_virtual_network")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}
...
control "virtual_network_gateway_expected_tag_values" {
  ...
  sql         = replace(local.expected_tag_values_sql, "__TABLE_NAME__", "azure_virtual_network_gateway")
  param "expected_tag_values" {
    default = var.expected_tag_values
  }
}